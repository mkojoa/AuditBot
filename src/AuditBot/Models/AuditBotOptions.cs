...
{
    public static class AuditBotOptions
    {
        /// <summary>
        ...
        /// <summary>
        /// Gets or Sets the Default audit-bot scope factory.
        /// </summary>
        public static IAuditBotScopeFactory AuditBotScopeFactory
        {
            get
            {
            ...
            set
            {
                _auditScopeFactory = value ?? new AuditBotScopeFactory();
            }
        }
        ...
        private static IAuditBotScopeFactory _auditScopeFactory;

        static AuditBotOptions()
        {
            AuditDisabled = false;
            ...
            //ResetCustomActions();
            _auditScopeFactory = new AuditBotScopeFactory();
        }
